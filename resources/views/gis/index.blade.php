    ...
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-2xl p-5 shadow-sm border border-slate-200/80">
            <form method="GET" action="{{ route('gis.index') }}" class="space-y-4">
                ...
                {{-- SVG Workflow GIS: WILAYAH → KOORDINAT → ANALISIS SPASIAL → HASIL --}}
                <div class="p-3.5 sm:p-4 rounded-xl bg-slate-50/80 border border-slate-200/90 space-y-2.5">
                    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-1">
                        <div class="flex items-center gap-2">
                            <span class="text-xs">📐</span>
                            <span class="text-xs font-bold text-slate-800 uppercase tracking-wide">{{ __('Workflow Analisis Spasial GIS') }}</span>
                            <span class="text-[10px] font-semibold text-ocean-700 bg-ocean-50 border border-ocean-200 px-2 py-0.5 rounded-full">IKAN KECIL V1.2</span>
                        </div>
                        <span class="text-[11px] text-slate-400">{{ __('Alur komputasi spasial: Wilayah (Layer) → Koordinat → Point in Polygon (PIP) → Hasil Verifikasi') }}</span>
                    </div>
                    ...
                    <div class="hidden md:block w-full overflow-hidden">
                        <svg class="w-full h-auto max-w-full block select-none" viewBox="0 0 960 148" fill="none" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Alur analisis spasial: Wilayah ke Koordinat, Analisis Point in Polygon, hingga Hasil Terverifikasi">
                            <defs>
                                <marker id="gis-arrow-blue" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
                                    <path d="M 1 2 L 7 5 L 1 8 z" fill="#0284c7" />
                                </marker>
                                <marker id="gis-arrow-indigo" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
                                    <path d="M 1 2 L 7 5 L 1 8 z" fill="#6366f1" />
                                </marker>
                                <marker id="gis-arrow-green" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
                            ...
                            <g id="arrow-1">
                                <line x1="214" y1="74" x2="248" y2="74" stroke="#0284c7" stroke-width="2" marker-end="url(#gis-arrow-blue)" class="gis-anim-dash" stroke-dasharray="4 3" />
                            </g>
                            ...
                            <g id="arrow-2">
                                <line x1="460" y1="74" x2="494" y2="74" stroke="#6366f1" stroke-width="2" marker-end="url(#gis-arrow-indigo)" class="gis-anim-dash" stroke-dasharray="4 3" />
                            </g>
                            ...
                            <g id="arrow-3">
                                <line x1="706" y1="74" x2="740" y2="74" stroke="#059669" stroke-width="2" marker-end="url(#gis-arrow-green)" class="gis-anim-dash" stroke-dasharray="4 3" />
                            </g>
                    ...
                    <div class="block md:hidden w-full max-w-sm mx-auto overflow-hidden">
                        <svg class="w-full h-auto max-w-full block select-none" viewBox="0 0 320 540" fill="none" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Alur analisis spasial vertikal untuk layar ponsel">
                            <defs>
                                <marker id="gis-arrow-down-blue" viewBox="0 0 10 10" refX="5" refY="6" markerWidth="6" markerHeight="6" orient="auto">
                                    <path d="M 2 1 L 5 7 L 8 1 z" fill="#0284c7" />
                                </marker>
                                <marker id="gis-arrow-down-indigo" viewBox="0 0 10 10" refX="5" refY="6" markerWidth="6" markerHeight="6" orient="auto">
                                    <path d="M 2 1 L 5 7 L 8 1 z" fill="#6366f1" />
                                </marker>
                                <marker id="gis-arrow-down-green" viewBox="0 0 10 10" refX="5" refY="6" markerWidth="6" markerHeight="6" orient="auto">
                            ...
                            {{-- ARROW DOWN 1 --}}
                            <line x1="160" y1="114" x2="160" y2="134" stroke="#0284c7" stroke-width="2" marker-end="url(#gis-arrow-down-blue)" class="gis-anim-dash" stroke-dasharray="4 3" />

                            {{-- NODE 2: KOORDINAT --}}
                            <g id="m-node-koordinat">
                            ...
                            {{-- ARROW DOWN 2 --}}
                            <line x1="160" y1="246" x2="160" y2="266" stroke="#6366f1" stroke-width="2" marker-end="url(#gis-arrow-down-indigo)" class="gis-anim-dash" stroke-dasharray="4 3" />

                            {{-- NODE 3: ANALISIS SPASIAL --}}
                            <g id="m-node-analisis">
                                ...
                                <g transform="translate(92, 306)">
                                    ...
                                    <rect y="32" width="206" height="13" rx="3" fill="#ede9fe" />
                                    <text x="6" y="42" font-size="7.5" font-weight="700" fill="#6d28d9" font-family="sans-serif">📐 Penentuan Zona RZWP3K</text>
                                </g>
                                <text x="20" y="368" font-size="7" fill="#94a3b8" font-family="sans-serif">Uji geometrik posisi terhadap batas wilayah</text>
                            </g>

                            {{-- ARROW DOWN 3 --}}
                            <line x1="160" y1="378" x2="160" y2="398" stroke="#059669" stroke-width="2" marker-end="url(#gis-arrow-down-green)" class="gis-anim-dash" stroke-dasharray="4 3" />
