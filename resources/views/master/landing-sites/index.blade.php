                ...
                <table class="w-full text-left border-collapse">
                    <thead>
                        <tr class="bg-ocean-900 border-b border-ocean-950 text-xs font-semibold text-white uppercase tracking-wider">
                            ...
                            <th class="py-3.5 px-4 w-28 text-white">{{ __('Kode') }}</th>
                            <th class="py-3.5 px-4 text-white">{{ __('Nama Tempat Pendaratan / TPI') }}</th>
                            <th class="py-3.5 px-4 text-white">{{ __('Tipe / Kelas') }}</th>
                            <th class="py-3.5 px-4 text-white">{{ __('Wilayah Administrasi') }}</th>
                            <th class="py-3.5 px-4 text-center text-white">{{ __('Koordinat GIS') }}</th>
                            <th class="py-3.5 px-4 text-center w-28 text-white">{{ __('Status') }}</th>
                            <th class="py-3.5 px-4 text-right w-28 text-white">{{ __('Aksi') }}</th>
                        </tr>
                    </thead>
