    ...
    <div class="glass-card p-6 sm:p-8 rounded-3xl border border-white/20 shadow-2xl space-y-6">
        ...
        <div class="hidden md:block w-full overflow-hidden bg-white/5 rounded-2xl p-4 border border-white/10">
            <svg class="w-full h-auto max-w-full block select-none" viewBox="0 0 960 148" fill="none" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Alur analisis spasial: Wilayah ke Koordinat, Analisis Point in Polygon, hingga Hasil Terverifikasi">
                <defs>
                    <marker id="gis-arrow-blue-landing" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
                        <path d="M 1 2 L 7 5 L 1 8 z" fill="#0284c7" />
                    </marker>
                    <marker id="gis-arrow-indigo-landing" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
                        <path d="M 1 2 L 7 5 L 1 8 z" fill="#6366f1" />
                    </marker>
                    <marker id="gis-arrow-green-landing" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
                        <path d="M 1 2 L 7 5 L 1 8 z" fill="#059669" />
                    </marker>
                </defs>

                {{-- NODE 1: WILAYAH --}}
                <g id="node-wilayah-landing">
                ...
                <g id="arrow-1-landing">
                    <line x1="214" y1="74" x2="248" y2="74" stroke="#0284c7" stroke-width="2" marker-end="url(#gis-arrow-blue-landing)" class="gis-anim-dash" stroke-dasharray="4 3" />
                </g>

                {{-- NODE 2: KOORDINAT --}}
                <g id="node-koordinat-landing">
                ...
                <g id="arrow-2-landing">
                    <line x1="460" y1="74" x2="494" y2="74" stroke="#6366f1" stroke-width="2" marker-end="url(#gis-arrow-indigo-landing)" class="gis-anim-dash" stroke-dasharray="4 3" />
                </g>

                {{-- NODE 3: ANALISIS SPASIAL --}}
                <g id="node-analisis-landing">
                ...
                <g id="arrow-3-landing">
                    <line x1="706" y1="74" x2="740" y2="74" stroke="#059669" stroke-width="2" marker-end="url(#gis-arrow-green-landing)" class="gis-anim-dash" stroke-dasharray="4 3" />
                </g>

                {{-- NODE 4: HASIL --}}
                <g id="node-hasil-landing">
        ...
        <div class="block md:hidden w-full max-w-sm mx-auto overflow-hidden bg-white/5 rounded-2xl p-3 border border-white/10">
            <svg class="w-full h-auto max-w-full block select-none" viewBox="0 0 320 540" fill="none" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Alur analisis spasial vertikal untuk layar ponsel">
                <defs>
                    <marker id="gis-arrow-down-blue-landing" viewBox="0 0 10 10" refX="5" refY="6" markerWidth="6" markerHeight="6" orient="auto">
                        <path d="M 2 1 L 5 7 L 8 1 z" fill="#0284c7" />
                    </marker>
                    <marker id="gis-arrow-down-indigo-landing" viewBox="0 0 10 10" refX="5" refY="6" markerWidth="6" markerHeight="6" orient="auto">
                        <path d="M 2 1 L 5 7 L 8 1 z" fill="#6366f1" />
                    </marker>
                    <marker id="gis-arrow-down-green-landing" viewBox="0 0 10 10" refX="5" refY="6" markerWidth="6" markerHeight="6" orient="auto">
                        <path d="M 2 1 L 5 7 L 8 1 z" fill="#059669" />
                    </marker>
                </defs>

                {{-- NODE 1: WILAYAH --}}
                <g id="m-node-wilayah-landing">
                ...
                {{-- ARROW DOWN 1 --}}
                <line x1="160" y1="114" x2="160" y2="134" stroke="#0284c7" stroke-width="2" marker-end="url(#gis-arrow-down-blue-landing)" class="gis-anim-dash" stroke-dasharray="4 3" />

                {{-- NODE 2: KOORDINAT --}}
                <g id="m-node-koordinat-landing">
                ...
                {{-- ARROW DOWN 2 --}}
                <line x1="160" y1="246" x2="160" y2="266" stroke="#6366f1" stroke-width="2" marker-end="url(#gis-arrow-down-indigo-landing)" class="gis-anim-dash" stroke-dasharray="4 3" />

                {{-- NODE 3: ANALISIS SPASIAL --}}
                <g id="m-node-analisis-landing">
                ...
                {{-- ARROW DOWN 3 --}}
                <line x1="160" y1="378" x2="160" y2="398" stroke="#059669" stroke-width="2" marker-end="url(#gis-arrow-down-green-landing)" class="gis-anim-dash" stroke-dasharray="4 3" />

                {{-- NODE 4: HASIL --}}
                <g id="m-node-hasil-landing">
